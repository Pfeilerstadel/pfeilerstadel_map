...
map.getView().fit([1390640.949577, 5808125.082394, 1697162.481687, 6002246.274936], map.getSize());
...
////controls container
    ...
    //center container
var centerContainer = new ol.control.Control({
    element: (() => {
...
map.addControl(centerContainer)
...
var centerContainerDiv = document.getElementById('center-container')
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Pfeilerstadel in Kärnten</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (147 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ein Projekt im Rahmen des Kärntner Architekturstipendiums 2025. Finanziert durch das Land Kärnten, Abt. 14 - "Kunst und Kultur". ©Christopher Juwan';
            }
